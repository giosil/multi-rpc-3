...
//        sValue = sb.toString();
  ...
  Hashtable toHashtable(Object object, boolean notNull)
  {
    ...
    if(object instanceof Mapable) {
      return toHashtable(((Mapable) object).toMap(), notNull);
    }
    if(object instanceof String) {
  ...
  Map toMap(Object object, boolean notNull)
  {
    ...
    if(object instanceof Mapable) {
      Map mapResult = ((Mapable) object).toMap();
      if(mapResult == null && notNull) return new HashMap(0);
      return mapResult;
    }
    if(object instanceof String) {
  ...
  Object toObject(Object object, String className, ClassLoader classLoader)
  {
    ...
    if(!className.startsWith("java.")){
      ...
      try {
        ...
        bean = beanClass.newInstance();
        if(bean instanceof Mapable) {
          ((Mapable) bean).fromMap(mapValues);
          return bean;
        }
      }
      catch(Exception ex) {
